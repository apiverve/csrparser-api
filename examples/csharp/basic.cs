    ...
    class CSRParserExample
    {
        ...
        static async Task<JsonDocument> CallCSRParserAPI()
        {
            try
            {
                ...
                // Request body
                var requestBody &#x3D; new { csr &#x3D; &quot;-----BEGIN CERTIFICATE REQUEST-----
...
-----END CERTIFICATE REQUEST-----&quot; };
        ...
        {
            Console.WriteLine("📤 Calling CSR Parser API...\n");

            var result = await CallCSRParserAPI();
