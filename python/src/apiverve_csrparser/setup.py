...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/csrparser',
        'Source': 'https://github.com/apiverve/csrparser-api',
        'Bug Tracker': 'https://github.com/apiverve/csrparser-api/issues'
    },
    classifiers=[
