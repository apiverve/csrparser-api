 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/csrparser?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/csrparser';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\CsrparserClient] {$message}\n";
        }
    }
}
