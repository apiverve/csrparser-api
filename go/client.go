...
const (
	baseURL        = "https://api.apiverve.com/v1/csrparser"
	defaultTimeout = 30 * time.Second
)

// Client is the CSR Parser API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new CSR Parser API client.
...
// Execute makes a request to the CSR Parser API with typed parameters.
//
