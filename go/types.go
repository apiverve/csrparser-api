// Package csrparser provides a Go client for the CSR Parser API.
//
// For more information, visit: https://apiverve.com/marketplace/csrparser?utm_source=go&utm_medium=readme
package csrparser
...
// Request contains the parameters for the CSR Parser API.
//
// Parameters:
//   - csr (required): string - The PEM-formatted Certificate Signing Request to parse
type Request struct {
...
// ResponseData contains the data returned by the CSR Parser API.
type ResponseData struct {
	...
	Fingerprints FingerprintsData `json:"fingerprints"`
	Pem string `json:"pem"`
...
// SubjectData represents the subject object.
type SubjectData struct {
	CommonName interface{} `json:"common_name"`
	Organization interface{} `json:"organization"`
	OrganizationalUnit interface{} `json:"organizational_unit"`
...
// PublicKeyData represents the public_key object.
...
// FingerprintsData represents the fingerprints object.
