...
namespace APIVerve.API.CSRParser
{
    ...
    /// <summary>
    /// Client for the CSRParser API
    /// </summary>
    public class CSRParserAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/csrparser";
        ...
        {
            { "csr", new ValidationRule { Type = "string", Required = true } }
        };
        ...
        public CSRParserAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public CSRParserAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public CSRParserAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, CSRParserQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(CSRParserQueryOptions options)
        {
        ...
        public ResponseObj Execute(CSRParserQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(CSRParserQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(CSRParserQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(CSRParserQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(CSRParserQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(CSRParserQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(CSRParserQueryOptions options)
        {
