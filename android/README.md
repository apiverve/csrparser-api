...
```gradle
dependencies {
    implementation 'com.github.apiverve:csrparser-api:1.1.12'
}
```
...
```java
import com.apiverve.csrparser.CSRParserAPIClient;
import com.apiverve.csrparser.APIResponse;
import com.apiverve.csrparser.APIException;

// Initialize the client
CSRParserAPIClient client = new CSRParserAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/csrparser](https://docs.apiverve.com/ref/csrparser)
...
- **Documentation:** [https://docs.apiverve.com/ref/csrparser](https://docs.apiverve.com/ref/csrparser)
- **Issues:** [GitHub Issues](https://github.com/apiverve/csrparser-api/issues)
